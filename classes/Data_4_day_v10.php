...
class Data_4_day_v10
{
    ...
    {
        $commands = [
            'CREATE TABLE IF NOT EXISTS \'4_day\'(
                humid	REAL,
                temp	REAL,
                time TEXT NOT NULL UNIQUE)',
            'CREATE INDEX IF NOT EXISTS time_index ON \'4_day\' (time);'
        ];
        //var_dump($commands);
    ...
    {
        $sql = "REPLACE INTO '4_day' VALUES(:humid,:temp,:time)";
    ...
    public static function getLast($esp_id, $limit = 1, $columns = '*')
    {
        ...
        $sql = "SELECT $columns FROM '4_day' ORDER BY time DESC LIMIT {$limit}";
