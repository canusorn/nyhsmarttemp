...
class Data_2_hr
{
    ...
    {
        $commands = [
            'CREATE TABLE IF NOT EXISTS \'2_hr\'(
                pm1	REAL,
                pm2	REAL,
                pm10 REAL,
                time TEXT NOT NULL UNIQUE)',
'CREATE INDEX IF NOT EXISTS time_index ON \'2_hr\' (time);'
        ];
        //var_dump($commands);
    ...
    {
        $sql = "INSERT INTO '2_hr' VALUES(:pm1,:pm2,:pm10,:time)";
    ...
    public static function getLast($esp_id, $limit = 1, $columns = '*')
    {
        ...
        $sql = "SELECT $columns FROM '2_hr' ORDER BY time DESC LIMIT {$limit}";
