...
class Data_6_day_v10
{
    ...
    {
        $commands = [
            'CREATE TABLE IF NOT EXISTS \'6_day\'(
                                        v1	REAL,
                                        i1	REAL,
                                        p1	REAL,
                                        e1	REAL,
            ...
            'CREATE INDEX IF NOT EXISTS time_index ON \'6_day\' (time);'
        ];
        //var_dump($commands);
    ...
    {
        $sql = "INSERT INTO '6_day' VALUES(:v1,:i1,:p1,:e1,:f1,:pf1,:v2,:i2,:p2,:e2,:f2,:pf2,:v3,:i3,:p3,:e3,:f3,:pf3,:time)";
    ...
    public static function getLast($esp_id, $limit = 1, $columns = '*')
    {
        ...
        $sql = "SELECT $columns FROM '6_day' ORDER BY time DESC LIMIT {$limit}";
