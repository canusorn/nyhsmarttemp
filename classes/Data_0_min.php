...
class Data_0_min
{
    ...
    {
        $commands = [
            'CREATE TABLE IF NOT EXISTS \'0_min\'(
                c0	REAL,
                c1	REAL,
                c2	REAL,
                c3	REAL,
            ...
            'CREATE INDEX IF NOT EXISTS time_index ON \'0_min\' (time);'
        ];
        //var_dump($commands);
    ...
    {
        $sql = "INSERT INTO '0_min' VALUES(:c0,:c1,:c2,:c3,:c4,:c5,:c6,:c7,:c8,:c9,:time)";
    ...
    public static function getLast($esp_id, $limit = 1, $columns = '*')
    {
        ...
        $sql = "SELECT $columns FROM '0_min' ORDER BY time DESC LIMIT {$limit}";
