...
class Data_1_min_v10
{
    ...
    public function createTables()
    {
        $commands = [
            ...
            'CREATE INDEX IF NOT EXISTS time_index ON \'1_min\' (time);'
        ];
        //var_dump($commands);
    ...
    {
        $sql = "INSERT INTO '1_min' VALUES(:voltage,:current,:power,:energy,:frequency,:pf,:time)";
    ...
    public static function getLast($esp_id, $limit = 1, $columns = '*')
    {
        ...
        $sql = "SELECT $columns FROM '1_min' ORDER BY time DESC LIMIT {$limit}";
