$(document).ready(function () {
    ...
    function uplotupdate() {
        ...
        let data = [label_timestamp, volt_history, curr_history, power_history, energy_history];
    ...
    function tablechart() {
        ...
        for (var count = label_history.length - 1; count >= 0; count--) {
            google_data.push([volt_history[count], curr_history[count], power_history[count], energy_history[count], label_history[count]]);
        }
    ...
    $("#csvdownload").click(function () {
        ...
        for (var count = 0; count < label_history.length; count++) {
            data.push([label_history[count], volt_history[count], curr_history[count], power_history[count], energy_history[count]]);
