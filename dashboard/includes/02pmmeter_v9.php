                        ...
                        <div class="row">
                            <div class="col">
                                <div class="description-block">
                                    ...
                                    <h5 class="description-header mb-2" id="pm1"></h5>
                                    <span class="description-text">PM 1.0</span>
                                </div>
                                <!-- /.description-block -->
                            </div>
                            <!-- /.col -->
                            <div class="col">
                                <div class="description-block">
                                    ...
                                    <h5 class="description-header mb-2" id="pm2"></h5>
                                    <span class="description-text">PM 2.5</span>
                                </div>
                                <!-- /.description-block -->
                            </div>
                            <!-- /.col -->
                            <div class="col">
                                <div class="description-block">
                                    ...
                                    <h5 class="description-header mb-2" id="pm10"></h5>
                                    <span class="description-text">PM 10.0</span>
                                </div>
                                <!-- /.description-block -->
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12" id="chart">
                <div class="card">
                    ...
                    <!-- end loading -->
                    <div class="card-header">
                        <h5 class="card-title" id="chart_name">ค่าความหนาแน่นฝุ่นล่าสุด [ug/m3]</h5>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="chart" id="Chart1">
                                    <!-- Sales Chart Canvas -->
                                    <canvas id="pmChart" height="300" style="height: 300px;"></canvas>
                                </div>
                                <!-- /.chart-responsive -->
                            </div>
                        </div>
...
<script type="text/javascript" src="js/02pmmeter.js?n=7"></script>