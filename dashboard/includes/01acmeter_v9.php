            ...
            <?php if (!is_null($activedevice['version']) && $activedevice['version'] >= 7) : ?>
                <div class="col-lg-3 col-6 setting-page" id="ota-form">
                    <div class="small-box bg-dark">
                        <div class="inner">
                            <h3>0.<?= number_format($activedevice['version'] *0.1,1) ?></h3>
...
<script type="text/javascript" src="js/ebill.js?n=4"></script>
<script type="text/javascript" src="js/01acmeter.js?n=5"></script>