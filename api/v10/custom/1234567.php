...
if (isset($data['c0']) || isset($data['c1']) || isset($data['c2']) || isset($data['c3']) || isset($data['c4']) || isset($data['c5']) || isset($data['c6'])) {
    $needsecupdate = true;
    if (isset($data['c0'])) $data_sec->c0 = $data['c0'];
    if (isset($data['c1'])) $data_sec->c1 = $data['c1'];
    if (isset($data['c2'])) $data_sec->c2 = $data['c2'];
    if (isset($data['c3'])) $data_sec->c1 = $data['c3'];    
    if (isset($data['c4'])) $data_sec->c0 = $data['c4'];
    if (isset($data['c5'])) $data_sec->c1 = $data['c5'];    
    if (isset($data['c6'])) $data_sec->c0 = $data['c6'];
...
if ($interval_min && $needsecupdate) {
    ...
    if (!is_null($data_sec_av[0])) {
        ...
        $data_min->c1 = $data_sec_av[1];
        $data_min->c2 = $data_sec_av[2];
        $data_min->c3 = $data_sec_av[3];
        $data_min->c4 = $data_sec_av[4];
        $data_min->c5 = $data_sec_av[5];
        $data_min->c6 = $data_sec_av[6];
    ...
    if ($interval_hour) {
        ...
        if (!is_null($data_min_av[0])) {
            ...
            $data_hr->c0 = $data_min_av[0];
            $data_hr->c1 = $data_min_av[1];
            $data_hr->c2 = $data_min_av[2];
            $data_hr->c3 = $data_min_av[3];
            $data_hr->c4 = $data_min_av[4];
            $data_hr->c5 = $data_min_av[5];
            $data_hr->c6 = $data_min_av[6];
        ...
        if ($interval_day >= 2 && !is_null($lastDays)) {
            ...
            for ($i = 1; $i < $interval_day; $i++) {
                ...
                if (!is_null($data_hr_av[0])) {
                    ...
                    $data_day->c0 = $data_hr_av[0];
                    $data_day->c1 = $data_hr_av[1];
                    $data_day->c2 = $data_hr_av[2];
                    $data_day->c3 = $data_hr_av[3];
                    $data_day->c4 = $data_hr_av[4];
                    $data_day->c5 = $data_hr_av[5];
                    $data_day->c6 = $data_hr_av[6];
